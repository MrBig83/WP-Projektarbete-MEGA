...
?>
	<div
		...
		<?php
			...
			?>
			<ul>
			<li>Telefonnummer: <?php the_field("telefonnummer"); ?></li>
			<li>Adress: <?php the_field("gatuadress"); ?></li>
			<li>Postnummer: <?php the_field("postnummer"); ?></li>
			<li>Ort: <?php the_field("ort"); ?></li>
			<li>Öppettider: <?php the_field("oppettider"); ?></li>
			<li>Hitta till oss: <a target="_blank" href=<?php the_field("google_maps-lank");?>>Klicka här</a></li>
</ul>
